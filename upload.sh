...
if [ $TRAVIS_PULL_REQUEST = "false" ] && [ $TRAVIS_BRANCH == 'master' ]; then
  ...
  ./google-cloud-sdk/bin/gcloud alpha test android run --app app-release.apk --device-ids m0,Nexus6P --os-version-ids 18,25 --orientations portrait --timeout 30m --max-depth 100 --project robot-scouter-app
fi

...
import com.supercilex.robotscouter.core.data.APP_LINK_BASE
...
fun templateIntent(id: String?): Intent =
        Intent(Intent.ACTION_VIEW).setData("$APP_LINK_BASE/template/$id".toUri())

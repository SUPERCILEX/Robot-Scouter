...
public class SpinnerTemplateViewHolder extends SpinnerViewHolder implements ScoutTemplateViewHolder {
    ...
    @Override
    protected ArrayAdapter<String> getAdapter(Metric.List listMetric) {
    ...
    public void onItemSelected(AdapterView parent, View view, int itemPosition, long id) {
        if (itemPosition == 0) {
            ...
            SpinnerTemplateDialog.Companion.show(getManager(),
                                                 ...
                                                 getMetric().getSelectedValueKey());
            getSpinner().setSelection(indexOfKey(getMetric().getSelectedValueKey()));
        } else {

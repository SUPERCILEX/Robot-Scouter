...
import com.supercilex.robotscouter.util.data.DatabaseUtilsKt;
...
import static com.supercilex.robotscouter.util.data.model.UserUtilsKt.getTemplateIndicesRef;
import static com.supercilex.robotscouter.util.ui.FirebaseAdapterUtilsKt.getHighestIntPriority;
...
public class ScoutTemplateSheet extends BottomSheetDialogFragment
    ...
    private TemplateItemTouchCallback mItemTouchCallback;
        ...
        if (TextUtils.isEmpty(mTemplateKey)) {
            DatabaseUtilsKt.observeOnce(getTemplatesListener(), true)
                    .addOnSuccessListener(templates -> {
                        ...
                        DatabaseReference newTemplateRef = getFIREBASE_TEMPLATES().push();
    ...
    private void setupRecyclerView() {
        ...
        mItemTouchCallback = new TemplateItemTouchCallback(mRootView);
        ...
        mAdapter = new TemplateAdapter(
                getFIREBASE_TEMPLATES().child(mTemplateKey),
    ...
    public void onClick(View v) {
        int id = v.getId();
        DatabaseReference templateRef = getFIREBASE_TEMPLATES().child(mTemplateKey);
